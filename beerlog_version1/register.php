...
<!--register section-->
			<form method = "post" action = "registerprocess.php">
				<p>Name:</p> 
				<input type = "text" name = "registername" id = "registername" size = "15" placeholder = "User name" maxlength = "15" required>
				<p>ID (max 15 characters):</p> 
				<input type = "text" name = "registerusername" id = "registerusername" size = "15" placeholder = "User name" maxlength = "15" required>
				<p>Password (max 4 characters):</p>
				<input type = "password" name = "registerpassword" id = "registerpassword" size = "15" placeholder = "Password" maxlength = "4" required>
				<br><br>
				<input id = "loginsubmitbutton" type = "submit" value = "Register Me">
			</form>
			<br>or<br><br>
			<form action = "login.php">
				<button id = "backtologinbutton">Back to Login page</button>
			</form>
		</div>
	</div>
<footer>
