		...
		<div class = "col-9 content" id = "contents">
			...
			if($_POST) {
				...
				mysql_select_db($mysqldbname, $con);
					...
					$user_name = $_POST['registername'];
					$user_ID = $_POST['registerusername'];
				...
				$sql = "INSERT INTO user (Name, UserName, UserPassword, DateOfRegistration) 
					VALUES ('$user_name','$user_ID','$user_password',now());";
			...
			?>
			<button onClick = "window.location.href = 'login.php'">Back to Login page</button>
		</div>
	</div>
