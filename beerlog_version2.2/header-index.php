	...
	<nav class = "navbar navbar-default">
		<div class = "container-fluid">
			<div class = "navbar-header">
				...
				<a class = "navbar-brand" href = "#" onclick = "pleaseLogin(); return false;" data-toggle = "tooltip" data-placement = "auto" 
						title = "Home">
			...
			<div class = "collapse navbar-collapse" id = "myNavbar">
				<ul class = "nav navbar-nav">
					<li href = "#" onclick = "pleaseLogin(); return false;"><a><span class = "glyphicon glyphicon-list"></span> Comment List</a></li>
					<li class = "dropdown">
						<a class = "dropdown-toggle" data-toggle = "dropdown" href = "#">
							...
							<ul class = "dropdown-menu">
								<li href = "#" onclick = "pleaseLogin(); return false;"><a href = "SBB.php"><span class = 'glyphicon glyphicon-heart'></span> By Beer Name</a></li>
								<li href = "#" onclick = "pleaseLogin(); return false;"><a href = "SBU.php"><span class = 'glyphicon glyphicon-user'></span> By User Name</a></li>
								<li href = "#" onclick = "pleaseLogin(); return false;"><a href = "SBP.php"><span class = 'glyphicon glyphicon-cutlery'></span> By Pub Name</a></li>
								<li href = "#" onclick = "pleaseLogin(); return false;"><a href = "SBD.php"><span class = 'glyphicon glyphicon-calendar'></span> By Date</a></li>
							</ul>
					</li>
				</ul>
